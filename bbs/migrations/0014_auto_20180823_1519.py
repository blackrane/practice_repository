# Generated by Django 2.0.8 on 2018-08-23 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bbs_withcomments', to=settings.AUTH_USER_MODEL, verbose_name='유저네임')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bbs_withcomments', to='bbs.With', verbose_name='Comment')),
            ],
        ),
        migrations.CreateModel(
            name='WithDisLike',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dislike_set', to='bbs.With')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='like_set', to='bbs.With')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.AddField(
            model_name='with',
            name='dislike_user_set',
            field=models.ManyToManyField(blank=True, related_name='Wdislike_user_set', through='bbs.WithDisLike', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='with',
            name='like_user_set',
            field=models.ManyToManyField(blank=True, related_name='Wlike_user_set', through='bbs.WithLike', to=settings.AUTH_USER_MODEL),
        ),
    ]
